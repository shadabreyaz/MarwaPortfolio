         ...
         {/* Contact Hero Section */}
          <section className="relative text-center max-w-3xl mx-auto mb-16 sm:mb-24">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl leading-tight font-semibold mt-2">
             Let’s Talk About Your Dental Needs and How We Can Save Your Tooth
            </h2>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                <div>
                    <h2 className="text-2xl sm:text-3xl md:text-4xl leading-tight font-semibold mb-3 sm:mb-4 lg:mb-6">
                        Get<span className="text-[rgb(var(--brand-teal))]"> in Touch </span> with Me
                    </h2>

                    <p className="text-gray-600 mb-6 leading-relaxed text-sm sm:text-base">
                      If you have a question or need guidance, fill out the form and our team will get back to you shortly.
                      You can also reach us directly by email.
                    </p>

                    <div className="text-sm sm:text-base">
                        <p className="font-semibold text-lg sm:text-xl text-[rgb(var(--brand-black))]">Clinic Location</p>
                        <p>GMC Clinics, Green Community, Jumeirah </p>
                        <p>Al Bustan Medical Center  </p>

                        <p className="font-semibold text-lg sm:text-xl mt-4 text-[rgb(var(--brand-black))]">Email</p>
                        <p>support@drolga.com</p>
